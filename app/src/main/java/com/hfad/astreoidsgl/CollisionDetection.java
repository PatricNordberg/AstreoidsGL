...
public class CollisionDetection {
    ...
    public static boolean segmentVsSegment(final PointF lineAStart, final PointF lineAEnd, final PointF lineBStart, final PointF lineBEnd) {
        final float x1 = lineAStart.x;
        final float y1 = lineAStart.y; //create some local names to make the typing easier further down
        final float x2 = lineAEnd.x;
        final float y2 = lineAEnd.y;
        final float x3 = lineBStart.x;
        final float y3 = lineBStart.y;
        final float x4 = lineBEnd.x;
        final float y4 = lineBEnd.y;
