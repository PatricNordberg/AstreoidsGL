...
public class Triangle{
    ...
    public Triangle() {
        ...
        int vertexShader = Game.loadShader(GLES20.GL_VERTEX_SHADER,
                vertexShaderCode);
        int fragmentShader = Game.loadShader(GLES20.GL_FRAGMENT_SHADER,
                fragmentShaderCode);
    ...
    public void draw(float[] mvpMatrix) { // pass in the calculated transformation matrix
        ...
        positionHandle = GLES20.glGetAttribLocation(_program, "vPosition");
        ...
        colorHandle = GLES20.glGetUniformLocation(_program, "vColor");
        ...
        vPMatrixHandle = GLES20.glGetUniformLocation(_program, "uMVPMatrix");
